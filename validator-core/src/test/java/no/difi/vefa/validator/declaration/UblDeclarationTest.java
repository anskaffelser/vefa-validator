...
public class UblDeclarationTest {
    ...
    public void validNormal() throws Exception {
        ...
        assertTrue(declaration.verify(s.getBytes()));
        assertEquals(declaration.detect(s.getBytes()), "profile#customization");
    }
    ...
    public void validOioublDeclaration() throws Exception {
        ...
        assertTrue(declaration.verify(s.getBytes()));
        assertEquals(declaration.detect(s.getBytes()), "Procurement-OrdSimR-BilSim-1.0#OIOUBL-2.02");
    }
    ...
    public void issue17() throws Exception {
        ...
        assertTrue(declaration.verify(s.getBytes()));
        assertEquals(declaration.detect(s.getBytes()), "profile#urn:www.cenbii.eu:transaction:biitrns010:ver2.0:extended:urn:www.peppol.eu:bis:peppol4a:ver2.0");
    }
    ...
    public void validDocument() throws Exception {
        ...
        assertTrue(declaration.verify(byteArrayOutputStream.toByteArray()));
    }
